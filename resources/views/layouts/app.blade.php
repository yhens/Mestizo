...
<section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
        <div class="navbar-header aside-md">
            ...
            <a href="#" class="navbar-brand" style="color: #FF0000; font-weight: 200" data-toggle="fullscreen">MESTIZO <span style="font-size: 13px; color: rgb(101, 189, 125); font-weight: 900">Hamburguesa</span></a>
        ...
        <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
            <li class="hidden-xs"><a href="#" class="dropdown-toggle"> <b>Vendedor</b></a></li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu animated fadeInRight">
                    ...
                    <li>
                        <a href="{{ url('password') }}">Mi cuenta</a>
                    </li>
                    <li class="divider"></li>
                    <li>
